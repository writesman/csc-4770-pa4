...
// Manages client-to-worker thread affinity and worker lifecycle.
...
public:
  ...
  // Gets the worker ID for a client, creating a new worker thread if one does
  // not exist for the client_id.
